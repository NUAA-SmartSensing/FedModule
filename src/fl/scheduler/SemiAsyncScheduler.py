...
class SemiAsyncScheduler(BaseScheduler.BaseScheduler):
            ...
            if last_s_time != current_time:
                ...
                if current_time == 1:
                    ...
                    for i in range(self.group_manager.get_group_num()):
                        ...
                        selected_client_threads = self.group_client_select(i, self.config["params"])
                    ...
                    last_s_time = current_time
                    selected_client_threads = self.group_client_select(group_num, self.config["params"])
    ...
    def group_client_select(self, i, params):
